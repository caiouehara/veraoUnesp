...
path = "./listas/lista2/tigre/results/exercicio7/"
...
def analiseFuncao(funcaoAproximada, funcaoExata, y0, h, a, b, nome):
      ...
      np.savetxt(path + f'resultado_exemplo07_{nome}.txt', matrix)
...
analiseFuncao(funcaoA, funcaoA_exata, 0, 10**(-4), 0, 1, "FunçãoA")
...
analiseFuncao(funcaoB, funcaoB_exata, 1, 10**(-4), 2, 3, "FunçãoB")
...
analiseFuncao(funcaoC, funcaoC_exata, 2, 10**(-4), 1, 2, "FunçãoC")
...
analiseFuncao(funcaoD, funcaoD_exata, 1, 10**(-4), 0, 1, "FunçãoD")
